...
DROP TABLE IF EXISTS public.gamification_stats CASCADE;
...
-- Create coaches table with correct schema
...
-- Create events table with correct schema matching frontend
...
-- Create daily_challenges table with correct schema
