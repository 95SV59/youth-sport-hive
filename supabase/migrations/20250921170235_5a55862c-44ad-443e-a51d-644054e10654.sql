-- Update sports_categories table with all major sports
...
('football', 'American Football', 'Strategic team sport with offensive and defensive plays', 'Gamepad2'),
('cricket', 'Cricket', 'Bat and ball sport popular in many countries', 'Gamepad'),
...
('badminton', 'Badminton', 'Racket sport played with a shuttlecock', 'Racquet'),
('table_tennis', 'Table Tennis', 'Fast-paced indoor racket sport', 'Gamepad2'),
('golf', 'Golf', 'Precision sport played on courses with clubs', 'Target'),
('hockey', 'Hockey', 'Fast team sport played with sticks and a puck/ball', 'Zap'),
('athletics', 'Track & Field', 'Collection of running, jumping, and throwing events', 'Trophy'),
('martial_arts', 'Martial Arts', 'Combat sports and self-defense disciplines', 'Shield'),
('cycling', 'Cycling', 'Sport involving bicycles for racing or recreation', 'Bike'),
('gymnastics', 'Gymnastics', 'Sport involving strength, flexibility, and artistry', 'Star'),
('rock_climbing', 'Rock Climbing', 'Adventure sport involving climbing natural rock formations', 'Mountain'),
('skateboarding', 'Skateboarding', 'Action sport performed on a skateboard', 'Gamepad2'),
('archery', 'Archery', 'Precision sport using bows and arrows', 'Target'),
('boxing', 'Boxing', 'Combat sport involving punching with gloved hands', 'Shield')
